...
export default class AboutPage extends Component {
    render() {
        return (
            <>
                <Container>
                    <h1>«Мы не обязаны свою жизнь посвящать только детям» Л.Петрановская</h1>

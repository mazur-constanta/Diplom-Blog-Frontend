...
export default class AboutPage extends Component {
    render() {
        return(
            <>
            <Container>
            <h5>Найди себя в ком-то из них. Будем исправлять крайность?</h5>
            <Tab.Container>
            ...
            <p align="justify">Прочитав эту фразу, я необычайно удивилась. Ведь бывает же такое? 
